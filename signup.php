...
.login-wrap{
    ...
    background:url(https://images.unsplash.com/photo-1571211905393-6de67ff8fb61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=600&q=60) no-repeat center;
        ...
        <form action="signup.php" method="post">
            ...
            <div class="login-form">
                <div class="sign-in-htm">
                    ...
                    <div class="hr"></div>
                    <div class="foot-lnk">
                        <a href="login_sess.php"><h5>Already member?</h5></a>
                    </div>
                ...
                <div class="sign-up-htm">
                   ...
                   <div class="group">
                   <center>
                        <a href="login_sess.php" class="button si">Login</a>
                    </center>
            </div>
            </div>
